...
def new_game():
    ...
    Contains calls to draw the game boards and a loop that keeps the game running.
    """
    ...
    while player_board.game_over or cpu_board.game_over == 0:
        ...
        # Cpu turn: makes a random selection on the board, checks if already selected
        count = 0
        while count < 1:
